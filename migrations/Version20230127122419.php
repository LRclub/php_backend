...
final class Version20230127122419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS user_visit_history (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, auth_time INT NOT NULL, INDEX IDX_9FBDD9DCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
