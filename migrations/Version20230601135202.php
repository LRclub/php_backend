...
final class Version20230601135202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE specialists_categories (id INT AUTO_INCREMENT NOT NULL, specialist_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_52E235F07B100C1A (specialist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
