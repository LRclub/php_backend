...
final class Version20230503151104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_63540593A9FC940 ON files (materials_id)');
        ...
        $this->addSql('CREATE INDEX IDX_9B1716B53A3123C7 ON materials (audio_id)');
        $this->addSql('CREATE INDEX IDX_9B1716B529C1004E ON materials (video_id)');
        $this->addSql('CREATE INDEX IDX_9B1716B5FAE957CD ON materials (preview_image_id)');
    }
