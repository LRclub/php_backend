...
final class Version20230606154743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE journal_answers (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, question VARCHAR(255) NOT NULL, answer LONGTEXT NOT NULL, date DATE NOT NULL, question_type VARCHAR(255) NOT NULL, INDEX IDX_806B88E3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
