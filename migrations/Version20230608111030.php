 ...
 */
final class Version20230608111030 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal_workbook DROP FOREIGN KEY FK_2C5040EEA76ED395');
        $this->addSql('DROP TABLE journal_workbook');
    }
}
