...
final class Version20230925125902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat_unread_count (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, chat_id INT NOT NULL, count INT DEFAULT NULL, update_time INT NOT NULL, INDEX IDX_2A6B4F4A76ED395 (user_id), INDEX IDX_2A6B4F41A9A7125 (chat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
