...
final class Version20230522143155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS tracker_actions (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, action_id INT NOT NULL, status VARCHAR(255) NOT NULL, completion_date INT NOT NULL, INDEX IDX_52178C03A76ED395 (user_id), INDEX IDX_52178C039D32F035 (action_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
