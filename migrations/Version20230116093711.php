...
final class Version20230116093711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS promocodes_used (id INT AUTO_INCREMENT NOT NULL, promocode_id INT NOT NULL, user_id INT NOT NULL, activation_time INT DEFAULT NULL, end_time INT DEFAULT NULL, INDEX IDX_DD0F09A4C76C06D9 (promocode_id), INDEX IDX_DD0F09A4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
