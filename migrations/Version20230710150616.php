...
final class Version20230710150616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE phone_restore_history (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, last_phone VARCHAR(180) NOT NULL, new_phone VARCHAR(180) NOT NULL, update_time VARCHAR(255) NOT NULL, INDEX IDX_5B79C641A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
