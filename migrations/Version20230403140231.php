 ...
 */
final class Version20230403140231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A9A55A4C3873EDDD ON courses');
        $this->addSql('ALTER TABLE courses DROP likes_collector_id');
        $this->addSql('ALTER TABLE materials DROP FOREIGN KEY FK_9B1716B53873EDDD');
        $this->addSql('DROP INDEX IDX_9B1716B53873EDDD ON materials');
        $this->addSql('ALTER TABLE materials DROP likes_collector_id');
